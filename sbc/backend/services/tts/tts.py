...
class TTS:
    ...
    def __new__(cls, route: str = None, cache_size: int = 32):
        ...
        Returns:
            TTS: The singleton instance of the class.
        """
        with cls._new_lock:
    ...
    def _get_stream(self) -> sd.OutputStream:
        ...
        """
        target_rate = int(self.sample_rate * 1.2)
        if self._stream is not None and self._stream.samplerate != self.sample_rate:
            self._close_stream()
