...
const QUESTIONS = [
    ...
    {
        q: "¿En qué año llegó el ser humano a la Luna?",
    ...
    {
        q: "¿Qué país tiene la mayor cantidad de habitantes en el mundo?",
        options: ["India", "China", "Estados Unidos", "Brasil"],
        correct: 0,
    },
    {
        q: "¿Cuál es el animal terrestre más rápido del mundo?",
        options: ["León", "Guepardo", "Antílope", "Hiena"],
        correct: 1,
    },
    {
    ...
    },
    {
        ...
        options: ["206", "210", "198", "300"],
        correct: 0,
    },
    {
        q: "¿Cuál es el río más largo del mundo?",
        options: ["Nilo", "Misisipi", "Amazonas", "Yangtsé"],
        correct: 2,
    },
    {
        q: "¿Qué instrumento musical tiene 88 teclas?",
        options: ["Organo", "Acordeón", "Piano", "Arpa"],
        correct: 2,
    },
    {
    ...
    {
        q: "¿Cual es la función de kibo?",
        options: ["Asistente", "Robot de pelea", "Auto"],
        correct: 0,
    },
];
